...
<p align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/arshiahsn/GoBackN"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/arshiahsn/GoBackN">View Demo</a>
    ·
    <a href="https://github.com/arshiahsn/GoBackN/issues">Report Bug</a>
    ·
    <a href="https://github.com/arshiahsn/GoBackN/issues">Request Feature</a>
  </p>
</p>
...
Implementation of an FTP client that works based on the TCP/IP go-back-n protocol.
...
### Running
   ...
   ```sh
   java GoBackDriver -i <file_name> [optional] -w <window_size> -s <server_name> -p <port_number> -t <timeout>
   ```   
